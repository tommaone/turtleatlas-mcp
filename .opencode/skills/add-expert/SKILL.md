...
name: add-expert
description: |
  Add, update, or correct domain expert knowledge files in the turtleatlas-mcp
  knowledge base. Also updates the schema archive (tables.zip) and index.js
  keyword map. Use when the user mentions "add expert", "create expert file",
  "update knowledge", "fix the knowledge base", "add knowledge",
  "document a table", or similar.
metadata:
  source: Ported from .claude/skills/add-expert — opencode + Claude Code compatible
---
